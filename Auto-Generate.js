...
direct_to_link = 'bungabdi0001.blogspot.com';
type_direct = 'only'; //all or only
no_direct_domain ='facebook.com,wa.me,twitter.com,pinterest.com';
only_direct_domain = 'drive.google.com,pastelink.net';
                ...
                if (filter_bungabdi_tampan3 < bungabdi_tampan.length) {
                    if (kasian_si_jomblo[filter_bungabdi_tampan3] > 0) {
                        ...
                        if (document.getElementsByTagName('a')[dunia_cuman_sebentar].href.split('').length > 0) {
                            ...
                            var ibuku_baik = codingbungabdi.amankan(rajin_sholat_ya, 'bungabdi')
                            var mengantuk = hasilgetlinkarp[parseInt(Math.random() * hasilgetlinkarp.length)] + '#go=' + ibuku_baik;
